...
class game{
  ...
  `a_playid` bigint(10) NOT NULL COMMENT '角色ID',
  `a_date` datetime NOT NULL COMMENT '跳转时间',
  PRIMARY KEY (`a_id`)
  ...
  `a_date` datetime NOT NULL COMMENT '跳转时间',
  PRIMARY KEY (`a_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='跳转到创角页'";
  ...
  `sx` int(11) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='行为分析缓存表'";
  ...
  `gmtz` int(10) NOT NULL DEFAULT '0' COMMENT '购买挑战次数',
  `guwu` int(10) NOT NULL DEFAULT '0' COMMENT '鼓舞',
  `qccd` int(10) NOT NULL DEFAULT '0' COMMENT '清除CD',
  `tzcs` int(10) NOT NULL DEFAULT '0' COMMENT '挑战次数',
  `djt` int(10) NOT NULL DEFAULT '0' COMMENT '点将台挑战次数',
  `djtzj` int(10) NOT NULL DEFAULT '0' COMMENT '点将台增加挑战次数',
  `mjone` int(10) NOT NULL DEFAULT '0' COMMENT '春秋古墓摸金1次',
  `mjten` int(10) NOT NULL DEFAULT '0' COMMENT '春秋古墓摸金10次',
  `mjfifty` int(10) NOT NULL DEFAULT '0' COMMENT '春秋古墓摸金50次',
  `dzmjone` int(10) NOT NULL DEFAULT '0' COMMENT '大周古墓摸金1次',
  `dzmjten` int(10) NOT NULL DEFAULT '0' COMMENT '大周古墓摸金10次',
  `dzmjfifty` int(10) NOT NULL DEFAULT '0' COMMENT '大周古墓摸金50次',
  `tzyk` int(10) NOT NULL DEFAULT '0' COMMENT '投资月卡钱庄',
  `tzqz` int(10) NOT NULL DEFAULT '0' COMMENT '投资升级钱庄',
  `tzgj` int(10) NOT NULL DEFAULT '0' COMMENT '挑战鬼将精英',
  `tzsj` int(10) NOT NULL DEFAULT '0' COMMENT '挑战神将boss',
  `bssq` int(10) NOT NULL DEFAULT '0' COMMENT '宝石镶嵌',
  `bsrh` int(10) NOT NULL DEFAULT '0' COMMENT '宝石融合',
  `bszh` int(10) NOT NULL DEFAULT '0' COMMENT '宝石转换',
  `bscl` int(10) NOT NULL DEFAULT '0' COMMENT '宝石纯炼',
  `qh` int(10) NOT NULL DEFAULT '0' COMMENT '强化',
  `xl` int(10) NOT NULL DEFAULT '0' COMMENT '洗炼',
  `fj` int(10) NOT NULL DEFAULT '0' COMMENT '分解',
  `sj` int(10) NOT NULL DEFAULT '0' COMMENT '升级',
  `rl` int(10) NOT NULL DEFAULT '0' COMMENT '熔炼',
  `jl` int(10) NOT NULL DEFAULT '0' COMMENT '精炼',
  `sbjs` int(10) NOT NULL DEFAULT '0' COMMENT '神兵晋升次数',
  `sbzl` int(10) NOT NULL DEFAULT '0' COMMENT '神兵注灵',
  `sbwx` int(10) NOT NULL DEFAULT '0' COMMENT '神兵五行变化',
  `sbcd` int(10) NOT NULL DEFAULT '0' COMMENT '神兵聚灵清除CD次数',
  `sbjl` int(10) NOT NULL DEFAULT '0' COMMENT '神兵聚灵',
  `wjlg` int(10) NOT NULL DEFAULT '0' COMMENT '武将成长拉杆次数',
  `wjjn` int(10) NOT NULL DEFAULT '0' COMMENT '武将技能刷新次数',
  `wjps` int(10) NOT NULL DEFAULT '0' COMMENT '武将配饰升星',
  `wjzs` int(10) NOT NULL DEFAULT '0' COMMENT '武将转生',
  `wjjc` int(10) NOT NULL DEFAULT '0' COMMENT '武将继承',
  `bsbf` int(10) NOT NULL DEFAULT '0' COMMENT '武将兵书拜访次数',
  `bsxf` int(10) NOT NULL DEFAULT '0' COMMENT '武将兵书寻访次数',
  `xxcd` int(10) NOT NULL DEFAULT '0' COMMENT '星宿清除冷却CD',
  `xxdl` int(10) NOT NULL DEFAULT '0' COMMENT '星宿点亮',
  `xxzx` int(10) NOT NULL DEFAULT '0' COMMENT '星宿占星',
  `gxsh` int(10) NOT NULL DEFAULT '0' COMMENT '观星收获',
  `gxnt` int(10) NOT NULL DEFAULT '0' COMMENT '观星逆天改命',
  `zjdy` int(10) NOT NULL DEFAULT '0' COMMENT '坐骑丹药喂养',
  `zjdj` int(10) NOT NULL DEFAULT '0' COMMENT '坐骑道具喂养',
  `zjtp` int(10) NOT NULL DEFAULT '0' COMMENT '坐骑突破内丹',
  `zjjn` int(10) NOT NULL DEFAULT '0' COMMENT '坐骑技能升级',
  `zjhh` int(10) NOT NULL DEFAULT '0' COMMENT '坐骑幻化',
  `gjsd` int(10) NOT NULL DEFAULT '0' COMMENT '国家商店购买',
  `gjml` int(10) NOT NULL DEFAULT '0' COMMENT '国家谋略学习',
  `yjfs` int(10) NOT NULL DEFAULT '0' COMMENT '邮件发送次数',
  `dw` int(10) NOT NULL DEFAULT '0' COMMENT '创建队伍',
  `shcs` int(10) NOT NULL DEFAULT '0' COMMENT '送花次数',
  `hytj` int(10) NOT NULL DEFAULT '0' COMMENT '好友添加',
  `hysc` int(10) NOT NULL DEFAULT '0' COMMENT '好友删除',
  `hyzf` int(10) NOT NULL DEFAULT '0' COMMENT '好友祝福',
  `qdlj` int(10) NOT NULL DEFAULT '0' COMMENT '签到领奖',
  `bc1` int(10) NOT NULL DEFAULT '0' COMMENT '补偿50%领取',
  `bc2` int(10) NOT NULL DEFAULT '0' COMMENT '补偿100%领取',
  `scgm` int(10) NOT NULL DEFAULT '0' COMMENT '商城购买次数',
  PRIMARY KEY (`a_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='行为统计'";
  ...
  `c_playid` bigint(10) NOT NULL,
  `c_time` datetime NOT NULL,
  PRIMARY KEY (`c_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='创角并成功登录临时表'";
  ...
  `c_time` datetime NOT NULL,
  PRIMARY KEY (`c_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='创角成功临时表'";

        mysql_query($sql,$con);

        $sql ="CREATE TABLE `chongzhi` (
  `c_id` int(11) NOT NULL AUTO_INCREMENT,
  `c_openid` varchar(100) COLLATE utf8_unicode_ci NOT NULL COMMENT '账号',
  `c_openkey` varchar(100) COLLATE utf8_unicode_ci NOT NULL COMMENT '临时密码',
  `c_pf` varchar(20) COLLATE utf8_unicode_ci NOT NULL COMMENT '平台',
  `c_num` int(10) NOT NULL DEFAULT '1' COMMENT '购买数量',
  `c_price` int(10) NOT NULL DEFAULT '0' COMMENT '价格',
  `c_billno` varchar(100) COLLATE utf8_unicode_ci NOT NULL COMMENT '交易流水号',
  `c_itemid` int(10) NOT NULL DEFAULT '0' COMMENT '物品ID',
  `payamt_coins` int(10) NOT NULL DEFAULT '0' COMMENT '扣取币数',
  `pubacct_payamt_coins` int(10) NOT NULL DEFAULT '0' COMMENT '扣取券数',
  `token_id` varchar(100) COLLATE utf8_unicode_ci NOT NULL COMMENT '订单号',
  `c_ts` int(10) NOT NULL COMMENT '申请时间',
  `version` varchar(20) COLLATE utf8_unicode_ci NOT NULL COMMENT '版本号',
  `zoneid` int(10) NOT NULL DEFAULT '0' COMMENT '发货分区',
  `c_time` datetime NOT NULL COMMENT '插入时间',
  `c_state` int(4) NOT NULL DEFAULT '0' COMMENT '请求状态 0 请求 1 成功',
  `c_pid` bigint(20) NOT NULL COMMENT '角色id',
  `c_sid` int(4) NOT NULL DEFAULT '1' COMMENT '服务器ID',
  PRIMARY KEY (`c_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='Q点支付'";

        mysql_query($sql,$con);

        $sql ="CREATE TABLE `chuanj` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `time` date NOT NULL DEFAULT '0000-00-00' COMMENT '插入时间',
  ...
  `c_playid` bigint(20) NOT NULL COMMENT '角色ID',
  ...
  `c_id` int(10) NOT NULL AUTO_INCREMENT,
  `c_playid` bigint(20) NOT NULL,
  `c_time` datetime NOT NULL,
  PRIMARY KEY (`c_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='创角成功登录'";
  ...
  `c_time` datetime NOT NULL,
  PRIMARY KEY (`c_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='创角成功'";
  ...
  `c_date` datetime NOT NULL DEFAULT '0000-00-00 00:00:00' COMMENT '所属日期',
  PRIMARY KEY (`c_id`),
  ...
  `d_playid` bigint(20) unsigned NOT NULL COMMENT '角色ID',
  ...
  `d_user` varchar(100) COLLATE utf8_unicode_ci NOT NULL COMMENT '用户名',
  `d_ip` varchar(25) COLLATE utf8_unicode_ci NOT NULL COMMENT 'IP',
  `d_userid` bigint(20) NOT NULL COMMENT '角色ID',
  `d_date` datetime NOT NULL COMMENT '登陆的时间',
  PRIMARY KEY (`d_id`),
  KEY `d_user` (`d_user`) USING BTREE,
  KEY `d_ip` (`d_ip`) USING BTREE
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='用户登陆具体信息'";
  ...
  `d_id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `d_playid` bigint(13) NOT NULL COMMENT '角色ID',
  ...
  PRIMARY KEY (`d_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='盗王陵重置'";

        mysql_query($sql,$con);

        $sql ="CREATE TABLE `dwltg` (
  `d_id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `d_playid` bigint(20) NOT NULL COMMENT '角色ID',
  ...
  `prop_id2` int(11) NOT NULL DEFAULT '0' COMMENT '升级材料2',
  `prop_num2` int(11) NOT NULL DEFAULT '0' COMMENT '升级材料2数量',
  ...
  `f_playid` bigint(20) NOT NULL COMMENT '角色ID',
  ...
  PRIMARY KEY (`f_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='副本重置'";

        mysql_query($sql,$con);

        $sql ="CREATE TABLE `fbgm` (
  `f_id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `f_account` varchar(100) COLLATE utf8_unicode_ci NOT NULL COMMENT '账号',
  `f_playid` bigint(20) NOT NULL COMMENT '角色ID',
  ...
  `f_time` date NOT NULL COMMENT '入库时间',
  PRIMARY KEY (`f_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='副本次数购买'";
  ...
  `f_time` date NOT NULL COMMENT '入库时间',
  PRIMARY KEY (`f_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='副本挑战'";
  ...
  `g_playid` bigint(11) unsigned NOT NULL DEFAULT '0' COMMENT '角色ID',
  ...
  PRIMARY KEY (`g_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='购买任务次数'";

        mysql_query($sql,$con);

        $sql ="CREATE TABLE `gold_list` (
  `g_id` int(10) NOT NULL AUTO_INCREMENT,
  `g_playid` bigint(10) NOT NULL COMMENT '角色ID',
  `g_bgold` int(10) NOT NULL DEFAULT '0' COMMENT '绑定元宝',
  `g_gold` int(10) NOT NULL DEFAULT '0' COMMENT '元宝',
  `g_date` datetime NOT NULL COMMENT '生成时间',
  `g_type` int(6) NOT NULL DEFAULT '0' COMMENT '消费类型',
  PRIMARY KEY (`g_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci";
  ...
  PRIMARY KEY (`h_id`),
  KEY `h_date` (`h_date`) USING BTREE,
  KEY `h_nums` (`h_num`) USING BTREE
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='历史当前 在线人数'";

        mysql_query($sql,$con);

        $sql ="CREATE TABLE `ip` (
  `i_id` int(11) NOT NULL AUTO_INCREMENT,
  `i_ip` char(15) NOT NULL COMMENT 'IP ',
  `i_date` datetime NOT NULL,
  PRIMARY KEY (`i_id`),
  UNIQUE KEY `ip` (`i_ip`) USING BTREE,
  KEY `i_date` (`i_date`) USING BTREE
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='登陆历史IP表'";

        mysql_query($sql,$con);

        $sql ="CREATE TABLE `item` (
  `i_id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `i_playid` bigint(13) NOT NULL COMMENT '角色ID',
...
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='商城消费记录'";

        mysql_query($sql,$con);

        $sql ="CREATE TABLE `item0` (
  `i_id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `i_account` varchar(100) CHARACTER SET utf8 NOT NULL COMMENT '账号',
  `i_playid` bigint(20) NOT NULL COMMENT '角色ID',
  `i_shopid` int(5) NOT NULL COMMENT '商品ID',
  `i_price` int(5) NOT NULL COMMENT '单价',
  ...
  PRIMARY KEY (`a_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='炼化统计'";
  ...
  `i_price` int(5) NOT NULL COMMENT '单价',
  `i_type` smallint(2) NOT NULL COMMENT '价格类型 1铜钱 2 绑定铜钱 3 元宝 4 绑定元宝 5 礼券 6 经验 7 韬略 8 军功 9 精魄 10 声望 11 灵力 12 荣誉',
  `i_num` int(3) NOT NULL DEFAULT '0' COMMENT '购买数量',
  `i_dtype` smallint(1) NOT NULL DEFAULT '0' COMMENT '活动类型 1-普通购买 2活动购买 3秒杀',
  `i_date` datetime NOT NULL COMMENT '所属日期',
  `i_total` int(11) NOT NULL DEFAULT '0' COMMENT '人数',
  `i_playid` bigint(20) NOT NULL COMMENT '玩家角色id',
  PRIMARY KEY (`i_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='商城消费统计'";
  ...
  PRIMARY KEY (`l_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='登录概况2登，5登，10登等缓存表'";
  ...
  `m_creat` int(7) NOT NULL COMMENT '创号数（最新注册创角数去重）',
...
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='用户登陆概况'";
  ...
  `playid` int(11) NOT NULL COMMENT '玩家角色id',
  `coin_type` tinyint(4) NOT NULL COMMENT '价格类型 1铜钱 2 绑定铜钱 3 元宝 4 绑定元宝 5 礼券',
  `sub_type` int(11) NOT NULL COMMENT '子id',
  `coin_count` int(11) NOT NULL COMMENT '花费数量',
  `add_count` int(11) NOT NULL COMMENT '获得数量/获得经验等',
  `item_id` int(11) NOT NULL COMMENT '物品id',
  `date` datetime NOT NULL COMMENT '玩家操作时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='流水日志'";
  ...
  PRIMARY KEY (`m_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='美女道具刷新'";
  ...
  `m_time` date NOT NULL COMMENT '入库时间',
  PRIMARY KEY (`m_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='美女培养'";
  ...
  `m_time` date NOT NULL COMMENT '入库时间',
  PRIMARY KEY (`m_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='美女收获'";
...
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='用户在线时长表'";
  ...
  PRIMARY KEY (`p_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='行为消耗'";
  ...
  PRIMARY KEY (`p_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='平台具体登陆状况'";
  ...
  PRIMARY KEY (`q_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='奇遇'";
  ...
  PRIMARY KEY (`a_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='场景通关统计'";
  ...
  PRIMARY KEY (`s_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='上香'";
  ...
  PRIMARY KEY (`a_id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='任务完成统计'";

        mysql_query($sql,$con);

        $sql ="CREATE TABLE `task_player` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `playid` int(11) NOT NULL COMMENT '玩家角色id',
  `TaskId` int(11) NOT NULL COMMENT '任务id',
  `date` datetime NOT NULL COMMENT '完成时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci";
  ...
  `u_username` char(35) CHARACTER SET utf8 COLLATE utf8_unicode_ci NOT NULL COMMENT '用户名',
  `u_date` datetime NOT NULL COMMENT '时间',
  PRIMARY KEY (`u_id`),
  UNIQUE KEY `u_username` (`u_username`) USING HASH,
  KEY `u_date` (`u_date`) USING BTREE
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='历史登陆用户账户表'";
  ...
  PRIMARY KEY (`w_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='完成任务'";
  ...
  PRIMARY KEY (`z_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='装备穿戴'";
  ...
  `z_time` date NOT NULL COMMENT '入库时间',
  PRIMARY KEY (`z_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='套装合成'";
  ...
  `z_time` date NOT NULL COMMENT '入库时间',
  PRIMARY KEY (`z_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='套装技能洗练'";
  ...
  `z_time` date NOT NULL COMMENT '入库时间',
  PRIMARY KEY (`z_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='装备强化'";
  ...
  `z_time` date NOT NULL COMMENT '入库时间',
  PRIMARY KEY (`z_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='追加功能洗练'";
  ...
  `z_time` date NOT NULL COMMENT '入库时间',
  PRIMARY KEY (`z_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci COMMENT='装备追加'";

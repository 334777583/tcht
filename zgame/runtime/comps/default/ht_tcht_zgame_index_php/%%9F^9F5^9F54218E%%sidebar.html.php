<?php /* Smarty version 2.6.18, created on 2014-07-22 14:29:13
...
/rechargeport/show" onclick="return false;">充值接口</a></li>
				<?php endif; ?>
				<?php if (in_array ( '00100700' , $this->_tpl_vars['user']['code'] )): ?>
					<li id="accport"><a href="<?php echo $this->_tpl_vars['app']; ?>
/dailyreport/show" onclick="return false;">每日报表</a></li>
				<?php endif; ?>
			</ul>
		</div>
	<?php endif; ?>
...
/residualvalue/show" onclick="return false;">剩余价值统计</a>	</li>
				...
				<?php if (in_array ( '00200500' , $this->_tpl_vars['user']['code'] )): ?>
					<li id="wing"><a href="<?php echo $this->_tpl_vars['app']; ?>
/wing/show" onclick="return false;">元宝消费比例</a>	</li>
				<?php endif; ?>
			</ul>
		 </div>
	 <?php endif; ?>
...
/singsevact/show"  onclick="return false;">玩家单服活跃统计</a></li>
				...
				<?php if (in_array ( '00300500' , $this->_tpl_vars['user']['code'] )): ?>
					<li id="sin"><a href="<?php echo $this->_tpl_vars['app']; ?>
/userloginlog/show"  onclick="return false;">登录日记</a></li>
				<?php endif; ?>
				
				<?php if (in_array ( '00300600' , $this->_tpl_vars['user']['code'] )): ?>
					<li id="sin"><a href="<?php echo $this->_tpl_vars['app']; ?>
/moneylog/show"  onclick="return false;">流水日志</a></li>
				<?php endif; ?>
				
				<?php if (in_array ( '00300700' , $this->_tpl_vars['user']['code'] )): ?>
					<li id="sin"><a href="<?php echo $this->_tpl_vars['app']; ?>
/upgrade/show"  onclick="return false;">升级日志</a></li>
				<?php endif; ?>
				
				<?php if (in_array ( '00300800' , $this->_tpl_vars['user']['code'] )): ?>
					<li id="sin"><a href="<?php echo $this->_tpl_vars['app']; ?>
/operation/show"  onclick="return false;">操作日志</a></li>
				<?php endif; ?>
...
/propanalysis/show" onclick="return false;">道具消耗统计</a>	</li>
				...
				<?php if (in_array ( '00401500' , $this->_tpl_vars['user']['code'] )): ?>
					<li id="typek"><a href="<?php echo $this->_tpl_vars['app']; ?>
/typekeep/show" onclick="return false;">渠道留存</a>	</li>
				<?php endif; ?>
				
				<?php if (in_array ( '00401600' , $this->_tpl_vars['user']['code'] )): ?>
					<li id="typel"><a href="<?php echo $this->_tpl_vars['app']; ?>
/typelose/show" onclick="return false;">渠道流失</a>	</li>
				<?php endif; ?>
				
				<?php if (in_array ( '00401700' , $this->_tpl_vars['user']['code'] )): ?>
					<li id="typel"><a href="<?php echo $this->_tpl_vars['app']; ?>
/chongzhilevel/show" onclick="return false;">充值等级分布</a>	</li>
				<?php endif; ?>
				
				<?php if (in_array ( '00401800' , $this->_tpl_vars['user']['code'] )): ?>
					<li id="typel"><a href="<?php echo $this->_tpl_vars['app']; ?>
/rollsuit/show" onclick="return false;">滚服统计</a>	</li>
				<?php endif; ?>
			</ul>
		</div>
	<?php endif; ?>
...
/gold/show" onclick="return false;">邮件发元宝</a></li>
				<?php endif; ?>
				<?php if (in_array ( '00501800' , $this->_tpl_vars['user']['code'] )): ?>
				<li id="gold"><a href="<?php echo $this->_tpl_vars['app']; ?>
/gmlogingame/show" onclick="return false;">游戏登入</a></li>
				<?php endif; ?>
				<?php if (in_array ( '00501900' , $this->_tpl_vars['user']['code'] )): ?>
				<li id="gold"><a href="<?php echo $this->_tpl_vars['app']; ?>
/gmchat/show" onclick="return false;">聊天内容监控</a></li>
				<?php endif; ?>
				
				<?php if (in_array ( '00502000' , $this->_tpl_vars['user']['code'] )): ?>
				<li id="gold"><a href="<?php echo $this->_tpl_vars['app']; ?>
/ipquery/show" onclick="return false;">ip链接查询</a></li>
				<?php endif; ?>
			</ul>
		</div>
	<?php endif; ?>
